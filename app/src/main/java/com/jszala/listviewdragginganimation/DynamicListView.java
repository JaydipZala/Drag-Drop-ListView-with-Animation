...
public class DynamicListView extends ListView {
    ...
    private OnItemDragDropListListener onItemDragDropListListener;
    ...
    public void setOnItemDragDropListListener(OnItemDragDropListListener onItemDragDropListListener) {
